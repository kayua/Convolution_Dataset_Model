INPUT_DATASET_TRAINING_IN='dataset/training/failed_training/S1m07.sort_u_1n_4n'
OUTPUT_DATASET_TRAINING_IN='samples_saved/samples_training_in/S1m07.sort_u_1n_4n'

INPUT_DATASET_TRAINING_OUT='dataset/training/original_training/S1m14.sort_u_1n_4n'
OUTPUT_DATASET_TRAINING_OUT='samples_saved/samples_training_out/S1m14.sort_u_1n_4n'

INPUT_DATASET_PREDICT_IN='dataset/predict/S1m07.sort_u_1n_4n'
OUTPUT_DATASET_PREDICT_OUT='samples_saved/samples_predict/S1m07.sort_u_1n_4n'

SAVE_NEURAL_MODEL='models_saved/model'

INPUT_ANALYSE_ORIGINAL='dataset/original/S1m14.sort_u_1n_4n'
INPUT_ANALYSE_CORRECTED='dataset/corrected/S1m07.sort_u_1n_4n_corrected'
INPUT_ANALYSE_FAILED='dataset/failed/S1m07.sort_u_1n_4n'
