...
python3 main.py CreateSamples --input_file_in $INPUT_DATASET_TRAINING_IN --output_file_in $OUTPUT_DATASET_TRAINING_IN
python3 main.py CreateSamples --input_file_in $INPUT_DATASET_TRAINING_OUT --output_file_in $OUTPUT_DATASET_TRAINING_OUT
python3 main.py CreateSamples --input_file_in $INPUT_DATASET_PREDICT_IN --output_file_in $OUTPUT_DATASET_PREDICT_OUT
