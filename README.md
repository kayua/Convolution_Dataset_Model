...
Impact of the number of epochs on average error for Dense, LSTM and Conv topologies (arrangements A=3, window width W=11), LSTM topology (arrangements A=3, window width W=11), and Conv. topology (arrangements A=8, squared window width W=H=256).
