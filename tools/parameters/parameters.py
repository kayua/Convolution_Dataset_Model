...
DEFAULT_TRAINING_METRICS = ['mse','Precision'] # OVER/UNDER FITTING ANALYSIS
#DEFAULT_TRAINING_METRICS =  'mse' # DEFAULT
...
DEFAULT_PREDICT_LOAD_MODEL_FILE = None
...
def dataset_parameters(parser):
    ...
    parser.add_argument("--learning_rate", type=float, help=help_msg, default=DEFAULT_LEARNING_RATE)
